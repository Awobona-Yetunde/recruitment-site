    ...
    <>
      ...
      <div className="bg-gray-100 py-20 px-5 text-center  mb-12 ">
        <p className="text-black text-base md:text-lg mb-4">
          At Axion Data Services, we are dedicated to providing our clients with
          service excellence, including secure data services. When you work with
          us, you can rest assured that your data is safe and secure.
        </p>
