    ...
    <>
      ...
      <div className="bg-gray-100 py-20 px-5 text-center  mb-12 ">
        <p className="text-black text-base md:text-lg mb-4">
          Our U.S.-only workforce is dedicated to providing prompt and
          responsive attention to our clients’ needs.
        </p>
...
export default DataExcellenceHero;
