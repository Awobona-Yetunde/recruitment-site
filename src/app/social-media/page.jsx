          ...
          <div className="flex flex-col lg:flex-row  items-center justify-center ">
            ...
            <div className="w-full lg:w-1/2 mb-6 ">
              ...
              <p className="text-gray-600 mb-4">
                Axion has performed data entry, data verification, and Internet
                research to support several social media apps to be used on
                mobile devices. Click on either of the case study links provided
